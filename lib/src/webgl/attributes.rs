...
use super::{WebGlCommon, WebGlRenderer, BufferDataImpl, DataType, BufferTarget, Id};
...
impl <T: WebGlCommon> WebGlRenderer<T> {
    ...
    pub fn upload_buffer_to_attribute<B: BufferDataImpl>(&self, id:Id, data:B, attribute_name:&str, opts:&AttributeOptions) -> Result<(), Error> {
