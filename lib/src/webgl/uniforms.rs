...
pub fn set_uniform_data(gl:&WebGlContext, loc:&WebGlUniformLocation, data: UniformData) {
...
pub fn set_uniform_matrix_data(gl:&WebGlContext, loc:&WebGlUniformLocation, data: UniformMatrixData) {
        let loc = Some(loc);
