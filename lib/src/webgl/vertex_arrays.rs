...
use super::{WebGlRenderer, Id, AttributeLocation, AttributeOptions, BufferTarget};
...
impl <'a> VertexArray<'a> {
    pub fn new(loc:AttributeLocation<'a>, buffer_id: Id, opts: &'a AttributeOptions) -> Self {
        Self {
            loc,
            buffer_id,
            opts
